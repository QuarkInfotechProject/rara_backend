...
class TempImageUploadService
{
    ...
    public function getFilename($file, $prefix= null): string
    {
        ...
        $filename = TempImageUploadService . phpdate('HisdmY') . TokenGenerator::randomString('alnum', 6) .'.'.$file->guessClientExtension();
    ...
    {
        $image_path = TempImageUploadService . phppublic_path($path) . $filename;
