...
class UserChangePasswordRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'newPassword.string' => 'Your new password should be a mix of letters, numbers, and symbols for better security.',
            'newPassword.min' => 'Hold on! Your new password must be at least :min characters long.',
            'newPassword.uncompromised' => 'For your safety, please choose a new password that hasn\'t been compromised.',
